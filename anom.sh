...
echo -e "\e[32m
       d8888888b    888 .d88888b. 888b     d888Y88b   d88P888     8888888888 
      d888888888b   888d88P" "Y88b8888b   d8888 Y88b d88P 888     888  888   
     d88P88888888b  888888     88888888b.d88888  Y88o88P  888     888  888   
    d88P 888888Y88b 888888     888888Y88888P888   Y888P   888     888  888   
   d88P  888888 Y88b888888     888888 Y888P 888   d888b   888     888  888   
  d88P   888888  Y88888888     888888  Y8P  888  d88888b  888     888  888   
 d8888888888888   Y8888Y88b. .d88P888   "   888 d88P Y88b Y88b. .d88P  888   
d88P     888888    Y888 "Y88888P" 888       888d88P   Y88b "Y88888P" 8888888 
\033[0m"
echo -e "    \e[31mTelegram Channel: \e[34m@anomch\033[0m | \e[31mTelegram Group: \e[34m@anomdev\033[0m\n"

#sleep
echo -e "\e[32mInstalling anom script ... \033[0m\n"
sleep 5
...
echo 'phpmyadmin phpmyadmin/app-password-confirm password anomhipass' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/mysql/admin-pass password anomhipass' | debconf-set-selections
echo 'phpmyadmin phpmyadmin/mysql/app-pass password anomhipass' | debconf-set-selections
...
echo -e "\n\033[33manom config and script have been installed successfully\033[0m"
...
if [ ! -d "/root/confanom" ]; then

    sudo mkdir /root/confanom
    
    sleep 1
    
    touch /root/confanom/dbrootanom.txt
    sudo chmod -R 777 /root/confanom/dbrootanom.txt
    sleep 1
    ...
    echo "${ASAS}user = 'root';" >> /root/confanom/dbrootanom.txt
    echo "${ASAS}pass = '${randomdbpasstxt}';" >> /root/confanom/dbrootanom.txt
    echo "${ASAS}path = '${RANDOM_NUMBER}';" >> /root/confanom/dbrootanom.txt
...
echo " "
echo -e "\e[32m
       d8888888b    888 .d88888b. 888b     d888 .d8888b.  .d8888b. 888      
      d888888888b   888d88P" "Y88b8888b   d8888d88P  Y88bd88P  Y88b888      
     d88P88888888b  888888     88888888b.d88888Y88b.     Y88b.     888      
    d88P 888888Y88b 888888     888888Y88888P888 "Y888b.   "Y888b.  888      
   d88P  888888 Y88b888888     888888 Y888P 888    "Y88b.    "Y88b.888      
  d88P   888888  Y88888888     888888  Y8P  888      "888      "888888      
 d8888888888888   Y8888Y88b. .d88P888   "   888Y88b  d88PY88b  d88P888      
d88P     888888    Y888 "Y88888P" 888       888 "Y8888P"  "Y8888P" 88888888 
\033[0m\n"
...
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/anomxui-timebot/settings/messageanom.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/anomxui-timebot/settings/rewardReport.php >/dev/null 2>&1") | sort - | uniq - | crontab -
(crontab -l ; echo "* * * * * curl https://${DOMAIN_NAME}/anomxui-timebot/settings/warnusers.php >/dev/null 2>&1") | sort - | uniq - | crontab -
...
ROOT_PASSWORD=$(cat /root/confanom/dbrootanom.txt | grep '$pass' | cut -d"'" -f2)
ROOT_USER="root"
...
wait
    ...
    if [[ $(mysql -u root -p$ROOT_PASSWORD -e "SHOW DATABASES LIKE 'anom'") ]]; then
        clear
        ...
        file_path="/var/www/html/anomxui-timebot/baseInfo.php"
        ...
        # print file
        echo -e "<?php" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "error_reporting(0);" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "${ASAS}botToken = '${YOUR_BOT_TOKEN}';" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "${ASAS}dbUserName = '${dbuser}';" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "${ASAS}dbPassword = '${dbpass}';" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "${ASAS}dbName = '${dbname}';" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "${ASAS}botUrl = 'https://${YOUR_DOMAIN}/anomxui-timebot/';" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "${ASAS}admin = ${YOUR_CHAT_ID};" >> /var/www/html/anomxui-timebot/baseInfo.php
        echo -e "?>" >> /var/www/html/anomxui-timebot/baseInfo.php

        sleep 1

        curl -F "url=https://${YOUR_DOMAIN}/anomxui-timebot/bot.php" "https://api.telegram.org/bot${YOUR_BOT_TOKEN}/setWebhook"
        MESSAGE="✅ The anom bot has been successfully installed! @anomch"
        curl -s -X POST "https://api.telegram.org/bot${YOUR_BOT_TOKEN}/sendMessage" -d chat_id="${YOUR_CHAT_ID}" -d text="$MESSAGE"
        
        
        sleep 1
        
        url="https://${YOUR_DOMAIN}/anomxui-timebot/createDB.php"
        curl $url
	    ...
	    sudo rm /var/www/html/anomxui-timebot/createDB.php
        ...
        echo " "
        echo -e "\e[100manom panel:\033[0m"
